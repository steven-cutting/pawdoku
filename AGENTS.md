...
Pawdoku is a Biscuit Games game: A sudoku puzzle game for Biscuit Games.
...
at <https://steven-cutting.github.io/pawdoku/>.
...
(<https://github.com/steven-cutting/biscuit_games_template>) at `v2.0.0`.
...
- A static site with no backend, prerendered by `adapter-static` and published
  as a project Pages site beneath `/pawdoku/`.
...
- A small Python toolchain (`uv`, `prek`, `ruff` and the `biscuit-games-tooling`
